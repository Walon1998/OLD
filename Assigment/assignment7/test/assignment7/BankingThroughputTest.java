...
public class BankingThroughputTest {
	...
	private static final int TRANSACTIONS = 2000000;
	...
	public void setUp(int actors, final int individualTransactions) {
		...
		transactions = individualTransactions * actors;
	...
	private void runTransactions() throws InterruptedException {
		...
		double total_transactions = transactions;
		double total_time_seconds = (end - start) / 1_000_000_000.0;
		...
		System.out.printf("Completed %d transactions in %.3f sec: %.4e transactions/sec\n", transactions,
				total_time_seconds, transactions_per_sec);
	}
