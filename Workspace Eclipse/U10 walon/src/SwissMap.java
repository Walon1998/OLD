...
public class SwissMap implements Drawable {
	 ...
	 */
	void show() {
		NightModeButton Button = new NightModeButton(this);
		PointOfInterest[] pois = new PointOfInterest[] { new City(this, "Zürich", 683354, 247353, 396030, 91.88),
				...
				new Mountain(this, "Dom", 632330, 104856, 4545), new Mountain(this, "Matterhorn", 617049, 91670, 4478),
	...
	public void draw(Window window) {
		if (nightMode) {
			...
			window.drawImage("Switzerland_adm_location_map_night.png", toGuiX(BG_MIN_EAST), toGuiY(BG_MAX_NORTH),
