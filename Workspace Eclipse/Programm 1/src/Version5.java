...
public class Version5 extends PApplet

{
	public static void main(String[] args) {
	
		String[] a = { "MAIN" };
		PApplet.runSketch(a, new Version5());
	...
	public void setup() {
		beginRecord(PDF, "Programm 1 " + ft.format(date) + " .pdf");
		background(255);
		smooth();
		stroke(255);
		strokeWeight(10);
	...
	public void draw() {
		...
		if (exit == true) {
			endRecord();
			saveFrame("Programm 1 " + ft.format(date) + " .tif");
			exit();
		}
