...
public class Programm7stable extends PApplet

{
	public static void main(String[] args) {
		...
		String[] a = { "MAIN" };
		PApplet.runSketch(a, new Programm7stable());
	...
	public void setup() {
		...
		beginRecord(PDF, "Programm7 Gabriela Spiel  " + ft.format(date) + " .pdf");
		background(255);
		smooth();
...
//strokeWeight(100);
	...
	public void draw() {
		...
		if (exit == true) {
			endRecord();
			saveFrame("Programm7 Gabriela Spiel  " + ft.format(date) + " .tif");
			exit();
		}
