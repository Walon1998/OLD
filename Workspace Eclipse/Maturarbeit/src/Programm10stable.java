...
public class Programm10stable extends PApplet

{
	public static void main(String[] args) {
		...
		String[] a = { "MAIN" };
		PApplet.runSketch(a, new Programm10stable());
...
int j=1;
	...
	public void setup() {
		...
		beginRecord(PDF, "Programm10 Gabriela Spiel " + ft.format(date) + " .pdf");
		background(255);
		smooth();
		rectMode(CENTER);
		noStroke();
	...
	public void draw() {	
		...
		//	ellipse(0, 0, 50 * n, 50 * n);
			...
			endRecord();
			saveFrame("Programm10 Gabriela Spiel  " + ft.format(date) + " .tif");
			exit();
		}
