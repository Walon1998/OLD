...
public class Programm9stable extends PApplet

{
	public static void main(String[] args) {
		...
		String[] a = { "MAIN" };
		PApplet.runSketch(a, new Programm9stable());
	...
	public void setup() {
		...
		beginRecord(PDF, "Programm9 Gabriela Spiel " + ft.format(date) + " .pdf");
		background(255);
		smooth();
	...
	public void draw() {
		...
		if (exit == true) {
			...
			endRecord();
			saveFrame("Programm9 Gabriela Spiel  " + ft.format(date) + " .tif");
			exit();
		}
