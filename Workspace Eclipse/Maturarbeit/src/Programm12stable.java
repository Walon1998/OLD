...
public class Programm12stable extends PApplet

{
	public static void main(String[] args) {
		...
		String[] a = { "MAIN" };
		PApplet.runSketch(a, new Programm12stable());
...
int mode =0;
	...
	public void setup() {
		...
		beginRecord(PDF, "Programm12 Gabriela Spiel  " + ft.format(date) + " .pdf");
		background(255);
		smooth();
		stroke(0,200);
	}
	...
	public void draw() {
		...
		if (exit == true) {
			endRecord();
			saveFrame("Programm12 Gabriela Spiel  " + ft.format(date) + " .tif");
			exit();
		}
