...
public class Programm6stable extends PApplet

{
	public static void main(String[] args) {
		...
		String[] a = { "MAIN" };
		PApplet.runSketch(a, new Programm6stable());
	...
	public void setup() {
		...
		beginRecord(PDF, "Programm6 Gabriela Spiel " + ft.format(date) + " .pdf");
		background(255);
		smooth();
		strokeCap(PROJECT);
		strokeWeight(3);
	...
	public void draw() {
		...
		if (exit == true) {
			endRecord();
			saveFrame("Programm6 Gabriela Spiel " + ft.format(date) + " .tif");
			exit();
		}
