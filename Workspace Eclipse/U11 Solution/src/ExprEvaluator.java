...
public class ExprEvaluator {
    ...
    /**
     * Creates an evaluator with a variable mapping that contains a single variable <i>x</i> that
     * has the given value.
     */
    ...
    /**
     * Evaluates the <i>expr</i> that corresponds to the next tokens and returns its value.
     */
    ...
    /**
     * Evaluates the <i>term</i> that corresponds to the next tokens and returns its value.
     */
    ...
    /**
     * Evaluates the <i>atom</i> that corresponds to the next token and returns its value.
     */
    ...
    /**
     * Creates a {@link EvaluationException} with a message that indicates that some unexpected
     * token occurred. Note that the caller still needs to throw this exception:
     * 
     * <pre>
