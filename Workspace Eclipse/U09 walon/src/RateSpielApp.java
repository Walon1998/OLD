...
public class RateSpielApp {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Spieler[] spieler = { new ZufallsWortSpieler(), new ZufallsWortSpielerMitGedaechtnis() };
		...
		for (int s = 0; s < spieler.length; s++) {
			System.out.println(spieler[s].name() + " hat durchschnittlich " + durchschnitt[s] + " Versuche benötigt.");
		}
	}
